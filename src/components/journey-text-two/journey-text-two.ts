...
interface AJBBibleMapJourneyTextTwo extends HTMLElement {
  journey: Journey;
  position: number;
  render: VoidFunction;
}
        ...
        <section class="ajb-bible-map__text-container p-2">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mt-0 mb-0 p2 ${classMap(showHideCss)}">
              ...
              brethren unto the grace of God.[40]
            </p>
            <p class="ajb-text mt-0 mb-0 p2 ${classMap(showHideCss)}">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mt-0 mb-0 p5 ${classMap(showHideCss)}">
              ...
              but the Spirit suffered them not.[7]
            </p>
            <p class="ajb-text mt-0 mb-0 p5 ${classMap(showHideCss)}">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mb-0 mt-0 p9 ${classMap(showHideCss)}">
              ...they came and besought them, and brought them out, and desired
              them to depart out of the city...[39]
            </p>
            <p class="ajb-text mb-0 mt-0 p9 ${classMap(showHideCss)}">
            ...
            <p class="ajb-text mb-0 mt-0 p9 ${classMap(showHideCss)}">
              ...
              came to Thessalonica[1]
            </p>
          </div>
          <div class="ajb-bible-map__text-target position-absolute">
            <p class="ajb-text mb-0 mt-0 p10 ${classMap(showHideCss)}">
              <strong>Acts 17</strong> [KJV]
            </p>
            <p class="ajb-text mb-0 mt-0 p10 ${classMap(showHideCss)}">
              ...
              and set all the city on an uproar[5]
            </p>
            <p class="ajb-text mb-0 mt-0 p10 ${classMap(showHideCss)}">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            <p class="ajb-text mb-0 mt-0 p11 ${classMap(showHideCss)}">
              <strong>Acts 17</strong> [KJV]
            </p>
            <p class="ajb-text mb-0 mt-0 p11 ${classMap(showHideCss)}">
              These were more noble than those in Thessalonica, in that they
              received the word with all readiness of mind, and searched the
              scriptures daily, whether those things were so.[11]
            </p>
            <p class="ajb-text mb-0 mt-0 p11 ${classMap(showHideCss)}">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mb-0 mt-0 p12 ${classMap(showHideCss)}">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mb-0 mt-0 p13 ${classMap(showHideCss)}">
              having shorn his head in Cenchrea: for he had a vow. [18] And he
              came to Ephesus[19]
            </p>
          </div>
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mb-0 mt-0 p14 ${classMap(showHideCss)}">
              ...he sailed from Ephesus.[21] And when he had landed at
              Caesarea[22]
            </p>
          </div>
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mb-0 mt-0 p15 ${classMap(showHideCss)}">
          ...
          <div class="ajb-bible-map__text-target position-absolute">
            ...
            <p class="ajb-text mb-0 mt-0 p16 ${classMap(showHideCss)}">
...
const ajbBibleMapJourneyTextTwoElement: CustomElement<AJBBibleMapJourneyTextTwo> =
  {
    journey: connect(scrollStore, scrollStoreJourneySelector),
    position: ({ journey }: AJBBibleMapJourneyTextTwo): number => {
      const result = 0;
      if (journey?.type === 2) {
...
define(
  "ajb-bible-map-journey-text-two",
  element(ajbBibleMapJourneyTextTwoElement),
);
export { ajbBibleMapJourneyTextTwoElement, type AJBBibleMapJourneyTextTwo };
