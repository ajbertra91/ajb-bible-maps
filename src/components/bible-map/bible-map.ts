...
import { connect, status, StoreStatus } from "base-web-components-store";
import "../base-map";
...
function AJBBibleMapTemplate(host: AJBBibleMap): TemplateResult {
  ...
  const showHideCss = {
    ...
    'p9-is-visible': host.position > 0 && host.position >= 44.0, // Acts 14 title
  ...
  return html`
    ...
    <section class="ajb-bible-map__text-target p-2">
      ...
      <div class="ajb-bible-map__text-target position-absolute">
        <p class="ajb-text mb-0 p1 ${classMap(showHideCss)}"><strong>Acts 13</strong> [KJV]</p>
        ...
        <p class="ajb-text mt-0 mb-0 p3 ${classMap(showHideCss)}">
          ...
          <strong>Seleucia</strong>; and from thence they sailed to Cyprus.[4]
        </p>
        <p class="ajb-text mt-0 mb-0 p4 ${classMap(showHideCss)}">
          And when they were at <strong>Salamis</strong>, they preached the word
          of God...[5]
        </p>
      ...
      <div class="ajb-bible-map__text-target position-absolute">
        ...
        <p class="ajb-text mt-0 mb-0 p7 ${classMap(showHideCss)}">
          ...
          <strong>Antioch</strong> in Pisidia, and went into the synagogue on the
          sabbath day...[14]
        </p>
      </div>
      <div class="ajb-bible-map__text-target position-absolute">
      ...
      <div class="ajb-bible-map__text-target position-absolute">
        <p class="ajb-text mb-0 p9 ${classMap(showHideCss)}"><strong>Acts 14</strong> [KJV]</p>
        <p class="ajb-text mt-0 mb-0 p10 ${classMap(showHideCss)}">
          ...
          They were ware of it, and fled unto <strong>Lystra</strong> and
          <strong>Derbe</strong>, cities of Lycaonia, and unto the region that
          lieth round about: And there they preached the gospel...[5-7]
        </p>
      </div>
      <div class="ajb-bible-map__text-target position-absolute">
        <p class="ajb-text mb-0 p9 ${classMap(showHideCss)}"><strong>Acts 14</strong> [KJV]</p>
        <p class="ajb-text mt-0 mb-0 p11 ${classMap(showHideCss)}">
          ...
          with Barnabas to <strong>Derbe</strong>.[19,20]
        </p>
      </div>
      <div class="ajb-bible-map__text-target position-absolute">
        <p class="ajb-text mb-0 p9 ${classMap(showHideCss)}"><strong>Acts 14</strong> [KJV]</p>
        <p class="ajb-text mt-0 mb-0 p12 ${classMap(showHideCss)}">
          ...
          they returned again to <strong>Lystra</strong>, and to
      ...
      <div class="ajb-bible-map__text-target position-absolute">
        ...
        <p class="ajb-text mt-0 mb-0 p13 ${classMap(showHideCss)}">
          ...
          And when they had preached the word in <strong>Perga</strong>, they went
          down into <strong>Attalia</strong>: And thence sailed to
...
const ajbBibleMapElement: CustomElement<AJBBibleMap> = {
  ...
  position: ({ journey }: AJBBibleMap): number => {
    let result = 0;
